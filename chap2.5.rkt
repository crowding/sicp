...
;; first question, does this technique lead to automatically
;; supporting, say, complex rationals? No because it calls the
;; primitive operators directly.

;;; Exercise 2.77.

;; The four new selectors are written below.

;; (magnitude '(complex rectangular 3 . 4))                     calls
;;  (apply-generic 'magnitude '(complex rectangular 3 . 4))     which calls
;;   (get 'magnitude 'complex),           which find nothing in the table unless
;;                                        the complex selector is defined.
;;  (apply-generic 'magnitude '(complex rectangular 3 . 4)      then calls
;;   (magnitude '(rectangular 3 . 4)                            which calls
;;    (apply-generic 'magnitude '(rectangular 3 . 4))           which calls
;;     (get 'magnitude 'rectangular),                           and then
;;     (install-rectangular-package:magnitude '(3 . 4))
;;                                                 which computes the magnitude.
